...
export const PLAYFIELD = {
  ...
  get leftOutLaneQuaternion () { return quaternionFromAxisAngle({x: 0, y: 1, z: 0 }, -this.outLaneRadians) },
  get rightOutLaneQuaternion () { return quaternionFromAxisAngle({x: 0, y: 1, z: 0 }, this.outLaneRadians) },
}
